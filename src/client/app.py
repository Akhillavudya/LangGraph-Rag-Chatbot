...
for message in st.session_state['message_history']:
    with st.chat_message(message['role']): #Create a chat bubble in Streamlit
        st.text(message['content'])  #Displays the message on that chat bubble


user_input = st.chat_input('Ask about your document or use tools') #creates the chat input box at the bottom of the app

if user_input:

    # first add the message to message_history
    st.session_state['message_history'].append({'role': 'user', 'content': user_input})  #appending user message in state
